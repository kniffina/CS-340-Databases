...
<body>
	...
	<div class="container filters">
		<div>
			...
			if(!($stmt = $mysqli->prepare("INSERT INTO characters (dname, class, race, homeland) VALUES (?,?,?,?)"))){
				echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
			}

			//post or create the new data
			if(!($stmt->bind_param("sssi",$_POST['DisplayName'],$_POST['Class'],$_POST['Race'],$_POST['Homeland']))){
			...
			if(!$stmt->execute()){
			    ...
			    echo "Added " . $stmt->affected_rows . " row to characters.";
			}
