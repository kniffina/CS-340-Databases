...
CREATE TABLE category_tbl(
    ...
    PRIMARY KEY (id),
    KEY idx_category_name_subcategory (name, subcategory)
...
CREATE TABLE operating_system (
    ...
    PRIMARY KEY (id),
    KEY idx_operating_system_name_version (name, version)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- insert the following devices instances into the device table 
-- (you should use a subquery to set up foriegn keys referecnes, no hard coded numbers):
